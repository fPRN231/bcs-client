          ...
          <div className='container'>
                ...
                <div className='doctor-widget'>
                    ...
                    <div className='doc-info-cont'>
                      ...
                      <div className='clinic-details'>
                        <p className='doc-location'>
                          <i className='fas fa-map-marker-alt'></i> Newyork, USA - <a href='#0'>Get Directions</a>
                        </p>
                        {/* <div>
                          {isOpen && (
                            <Lightbox
                  ...
                  <div className='doc-info-right'>
                    ...
                    <div className='doctor-action'>
                      ...
                      <a href='#0' className='btn btn-white call-btn' data-toggle='modal' onClick={() => this.openModal('voice')}>
                        <i className='fas fa-phone'></i>
                      </a>
                      <a href='#0' className='btn btn-white call-btn' data-toggle='modal' onClick={() => this.openModal('video')}>
            ...
            <div className='card'>
              <div className='card-body pt-0 user-tabs'>
                <Tabs className='tab-view' activeKey={this.state.key} onSelect={this.handleSelect} id='controlled-tab-example'>
                                ...
                                <div className='experience-content'>
                                  <div className='timeline-content'>
                                    <a href='#/' className='name'>
                                      American Veterinary Medical University
                                    </a>
                                    <div>BDS</div>
                            ...
                            <ul className='experience-list'>
                              <li>
                                ...
                                <div className='experience-content'>
                                  <div className='timeline-content'>
                                    <a href='#/' className='name'>
                                      Glowing Smiles Family Veterinary Clinic
                                    </a>
                              ...
                              <li>
                                ...
                                <div className='experience-content'>
                                  <div className='timeline-content'>
                                    <a href='#/' className='name'>
                                      Comfort Care Veterinary Clinic
                                    </a>
                              ...
                              <li>
                                ...
                                <div className='experience-content'>
                                  <div className='timeline-content'>
                                    <a href='#/' className='name'>
                                      Dream Smile Veterinary Practice
                                    </a>
                          ...
                          <div className='col-md-6'>
                            <div className='clinic-content'>
                              <h4 className='clinic-name'>
                                <a href='#0'>Smile Cute Pediatric Veterinary Center</a>
                              </h4>
                              ...
                              <div className='clinic-details mb-0'>
                                <h5 className='clinic-direction'>
                                  <i className='fas fa-map-marker-alt'></i> 2286 Sundown Lane, Austin, Texas 78749, USA <a href='#0'>Get Directions</a>
                                </h5>
                                <div>
                                  {isOpen && (
                                    <Lightbox
                      ...
                      <div className='location-list'>
                        <div className='row'>
                          <div className='col-md-6'>
                            <div className='clinic-content'>
                              <h4 className='clinic-name'>
                                <a href='#0'>The Family Optometristry Clinic</a>
                              </h4>
                              <p className='doc-speciality'>M.Sc. Veterinary</p>
                              <div className='rating'>
                                <i className='fas fa-star filled'></i>
                              ...
                              <div className='clinic-details mb-0'>
                                <p className='clinic-direction'>
                                  ...
                                  2883 University Street, Seattle, Texas Washington, 98155<a href='#0'>Get Directions</a>
                                </p>
                                <div>
                                  {isOpen && (
                                    <Lightbox
                            ...
                            <div className='comment'>
                              ...
                              <div className='comment-body'>
                                ...
                                <p className='comment-content'>
                                  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation. Curabitur non nulla sit amet nisl
                                  tempus
                                </p>
